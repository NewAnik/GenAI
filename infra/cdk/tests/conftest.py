...
NotificationsStack and StorefrontStack all need to synthesize together since StorefrontStack
cross-references the other stacks' VPC/security group/user pool/notifications queue.
"""
...
FAKE_CONTEXT = {
    ...
    "dbName": "storefront",
    "resendApiKeySecretArn": "arn:aws:secretsmanager:ap-south-1:123456789012:secret:resend-api-key-abc123",
}
...
def synth_stacks(
    ...
    notifications_stack = NotificationsStack(app, "TestNotificationsStack")
