"""Cold-start logging setup for the admin API Lambdas — mirrors storefront/logging_config.py.
...
query params can carry the same PII that keeps this codebase from logging request/response
bodies — it's meant to be flipped on temporarily while debugging, not left on.
"""
